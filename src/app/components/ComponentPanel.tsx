...
const ComponentPanel = () => {
  ...
  const onDragStart = (e: React.DragEvent<HTMLElement>, componentName: keyof typeof initialFieldAttributes) => {
    ...
    <div className="flex flex-col justify-between h-full w-[226px] lg:w-[300px]">
      <div className="flex flex-col h-screen flex-shrink-0 duration-200 bg-gray-50 border-x-[0.5px] border-gray-300 w-[226px] lg:w-[300px]">
        ...
        <div className="w-full px-4">
          <p className="text-sm text-gray-400 font-medium mt-2">Frequently used</p>
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 mt-3 gap-y-4">
            <button 
              aria-roledescription="draggable" 
              className="bg-white px-[3px] flex flex-col pt-3 pb-[6px] items-center rounded-md cursor-pointer border border-white shadow hover:shadow-md hover:shadow-gray-400/50 w-full"
              draggable
